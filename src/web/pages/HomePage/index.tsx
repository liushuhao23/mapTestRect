 ...
 * @Version: 2.0
 * @Autor: liushuhao
 * @Date: 2022-10-20 14:16:48
 * @LastEditors: liushuhao
 * @LastEditTime: 2022-11-18 15:13:03
 */
...
const Index: FC = () => {
  const init = (whData: {width: number | undefined, height: number | undefined}) => {
    Graph.registerNode(
      'topic',
      {
        inherit: 'rect',
  ...
  useEffect(() => {
    const whData = document.getElementById('mainContent')?.getBoundingClientRect()
    init({width: whData?.width! - 60, height: whData?.height! - 30})
  }, []);
  return (
    <>
